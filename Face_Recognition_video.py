...
stream = CamGear(source='https://youtu.be/Zp8rYV_lIcY', stream_mode = True, logging=True).start()
writer = None
...
while True:
    ...
    for encoding in encodings:
        votes = face_recognition.compare_faces(data['encodings'], encoding,tolerance=0.47)
        if True in votes:
